SELECT STANDORT_PK,
  ...
  XMLSerialize(CONTENT XMLRoot(xmlelement("messswert", XMLATTRIBUTES(STANDORT_PK standortPk, PROBEN_PKS probenPks)
...
FROM (SELECT DISTINCT T_BIS_STANDORT_D.PK AS STANDORT_PK,
          ...
          TO_DATE(T_BIS_PROBE_B.PROBENAHMEDATUM_TXT, 'YYYYMMDD') AS MAX_DATE,
          TO_DATE(T_BIS_PROBE_B.PROBENAHMEDATUM_TXT, 'YYYYMMDD') AS MIN_DATE,
    ...
    --HAVING COUNT(T_BIS_PROBE_B.PK) > 10
