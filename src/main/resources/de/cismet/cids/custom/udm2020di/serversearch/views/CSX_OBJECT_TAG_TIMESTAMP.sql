CREATE OR REPLACE FORCE VIEW CSX_OBJECT_TAG_TIMESTAMP ("CLASS_ID", "OBJECT_ID", "TAG_ID", "MAX_DATE", "MIN_DATE") AS 
SELECT
  (SELECT ID
   FROM CS_CLASS
...
FROM JT_MOSS_TAG
INNER JOIN MOSS_SAMPLE_VALUE ON MOSS_SAMPLE_VALUE.STATION = JT_MOSS_TAG.MOSS
