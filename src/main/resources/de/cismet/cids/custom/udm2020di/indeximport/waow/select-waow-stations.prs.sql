SELECT MESSSTELLEN.PK MESSSTELLE_PK, MESSSTELLEN.NAME MESSSTELLE_NAME, MESSSTELLEN.TYP MESSSTELLE_TYP, 
       ...
       ZUSTAENDIGESTELLE ZUSTAENDIGE_STELLE, /*BUNDESLAND,*/ GEWAESSER_NAME, /*GEWAESSER_EZK,*/
...
FROM
    (SELECT DISTINCT V_WAOW_MST_D.PK AS MESSTELLE_PK,
        ...
        V_WAOW_PARAM_D.UNIT_TXT AS PARAMETER_EINHEIT
    ...
    GROUP BY V_WAOW_MST_D.PK, V_WAOW_PARAM_D.PK, V_WAOW_PARAM_D.NAME_TXT, V_WAOW_PARAM_D.UNIT_TXT
