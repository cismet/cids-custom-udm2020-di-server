SELECT STANDORTE.STANDORT_PK,
       ...
       XMLELEMENT ("STANDORTPARAMETER", XMLATTRIBUTES(STANDORT_PK), xmlagg (xmlelement (PARAMETER, XMLATTRIBUTES(STANDORTPARAMETER_PK, STANDORTPARAMETER_NAME, STANDORTPARAMETER_WERT)))) 
        ,(SELECT 
...
FROM
  (SELECT DISTINCT STANDORT.PK STANDORT_PK,
   ...
   --WHERE ROWNUM < 10000 --STANDORT.PK = '7000001' 
...
GROUP BY STANDORTE.STANDORT_PK,
         ...
         STANDORTE.HOCHWERT,
         STANDORTE.RECHTSWERT
ORDER BY STANDORTE.STANDORT_PK DESC