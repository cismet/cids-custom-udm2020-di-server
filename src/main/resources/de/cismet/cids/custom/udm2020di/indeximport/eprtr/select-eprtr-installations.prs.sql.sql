SELECT  INSTALLATIONS.INSTALLATION_ID AS ID,
        ...
        XMLATTRIBUTES(
          ...
          (SELECT XMLELEMENT("ACTIVITIES", xmlagg (xmlelement ("ACTIVITY", XMLATTRIBUTES(
                ...
                ACTIVITY.ACT_IS_PRIMARY_PERF_ACTIVITY ISPRIMARY))))
        ...
        XMLELEMENT("ADDRESSES", xmlagg (
            XMLELEMENT ("ADDRESS", XMLATTRIBUTES(
                INSTALLATIONS.ADDRESS_TYPE addresstype,
                INSTALLATIONS.ADDRESS_REGION addressregion,
                INSTALLATIONS.ADDRESS_DISTRICT addressdistrict, 
                INSTALLATIONS.ADDRESS_POSTCODE addresspostcode,
                INSTALLATIONS.ADDRESS_STREET_NAME address_street_name))))),
