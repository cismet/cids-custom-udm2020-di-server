...
DELETE FROM TAG WHERE ID IN (SELECT DISTINCT EPRTR_INSTALLATION.NACE_CLASS FROM EPRTR_INSTALLATION);
DELETE FROM TAG WHERE ID IN (SELECT DISTINCT EPRTR_INSTALLATION.RIVER_CATCHMENT FROM EPRTR_INSTALLATION);
