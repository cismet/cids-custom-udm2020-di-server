SELECT DISTINCT MESSSTELLE.PK AS MESSSTELLE_PK, 
    ...
    --MAX(DECODE(PARAMWERT.FK_V_WAGW_PARAM_D_ID, 'G146', PARAMWERT.WERT_NUM)) AS G146,
    --MAX(DECODE(PARAMWERT.FK_V_WAGW_PARAM_D_ID, 'G145', PARAMWERT.WERT_NUM)) AS G145,
    --MAX(DECODE(PARAMWERT.FK_V_WAGW_PARAM_D_ID, 'G142', PARAMWERT.WERT_NUM)) AS G142
    ...
    --WHERE MESSSTELLE.PK IN ('PG10000122')
    --AND PARAM.PK IN('G146', 'G145', 'G142')
