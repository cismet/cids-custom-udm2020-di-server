SELECT MESSSTELLEN.PK, MESSSTELLEN.NAME, MESSSTELLEN.TYP, MESSSTELLEN.XKOORDINATE, 
       MESSSTELLEN.YKOORDINATE, ZUSTAENDIGESTELLE, /*, BUNDESLAND,*/ GWK_NAME,
...
(SELECT XMLELEMENT("proben", xmlagg (xmlelement ("probe", 
...
FROM
    ...
    /*WHERE V_WAGW_PARAMGRUPPE_D.PK IN('22',
                              '23',
    ...
    GROUP BY V_WAGW_MST_D.PK, V_WAGW_PARAM_D.PK, V_WAGW_PARAM_D.NAME_TXT
