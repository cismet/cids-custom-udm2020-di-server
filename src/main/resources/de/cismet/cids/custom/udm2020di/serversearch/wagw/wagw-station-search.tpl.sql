SELECT DISTINCT %CLASS_ID% AS class_id, WAGW_STATION.ID as id, WAGW_STATION.SRC_MESSSTELLE_PK as name 
FROM WAGW_STATION 
...
GROUP BY WAGW_STATION.ID, WAGW_STATION.SRC_MESSSTELLE_PK